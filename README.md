...
- Supabase 게임 서비스·인증 Edge 명령 라우터 로컬 구현, 운영 연결 미실행
- push·배포 전 로컬 검증 단계
...
- `supabase/functions/game-command/index.ts`: 인증 사용자 단일 Edge 명령 진입점
- `src/renewal/supabase-game-service.js`: 브라우저 원격 게임 서비스 어댑터
