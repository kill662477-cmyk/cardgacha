...
> 최종 동기화: 2026-07-18
> 현재 작업 범위: 로컬 migration·테스트 허용. commit·push·배포·운영 DB 실행 금지
...
- `docs/PDB-8-SEASON1-MIGRATION-SPEC.md`: 시즌1 계정 선별·초기화·랭커 보상 이관 기준
- `supabase/renewal_migration_001_accounts_reset.sql`: 리뷰용 시즌2 계정 이관 1차 migration, 운영 미실행
...
- 자동 테스트 23묶음 통과. 직전 밸런스 30일 성장 시뮬레이션 통과
