...
// ---- 멤버 도감 완성 보상표 (member -> P, 난이도별 차등, 최대 900) ----
// 크루 21명 개별 완성 보상. 멤버명은 cards.json 과 정확히 일치해야 한다.
// 명예유스/암연시는 개별이 아닌 컬렉션 단위 보상(COLLECTION_REWARDS)이라 여기서 제외.
const MEMBER_REWARDS = {
  '김윤환': 900, '지두두': 560, '토마토': 440, '임조이': 380, '소주양': 320,
  '주하랑': 260, '낭니': 260, '비타밍': 220, '먼진': 180, '남덕선': 160,
  '치리': 150, '아리송이': 150, '햇살': 140, '김민철': 110, '변현제': 110,
  '박준오': 100, '지동원': 100, '배성흠': 100, '박수범': 100, '사테': 100,
  '찌킹': 100,
};

// ---- 컬렉션 단위 완성 보상 (collection -> P) ----
// 해당 collection 카드를 전부 모아야 1회 지급. 라벨은 claim 시 member 파라미터로 온다.
const COLLECTION_REWARDS = { honor: 1000, dark: 1500 };
const COLLECTION_LABELS = { '명예유스': 'honor', '암연시': 'dark' };
...
module.exports = {
  RARITIES, RANK, PACKS, DISMANTLE_REFUND, MEMBER_REWARDS,
  COLLECTION_REWARDS, COLLECTION_LABELS,
  loadCards,
  cardById,
  openPack,
  seoulToday,
