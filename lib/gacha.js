...
// ---- 멤버 도감 완성 보상표 (member -> P, 난이도별 차등, 최대 450) ----
// 멤버명은 cards.json 과 정확히 일치해야 한다 (21명 전원).
const MEMBER_REWARDS = {
  '김윤환': 450, '지두두': 280, '토마토': 220, '임조이': 190, '소주양': 160,
  '주하랑': 130, '낭니': 130, '비타밍': 110, '먼진': 90, '남덕선': 80,
  '치리': 75, '아리송이': 75, '햇살': 70, '김민철': 55, '변현제': 55,
  '박준오': 50, '지동원': 50, '배성흠': 50, '박수범': 50, '사테': 50,
  '찌킹': 50,
};
