...
export const SUPPORT_ITEMS = {
  ...
  // hideWhenEmpty: 보유 0개일 때만 인벤토리 목록에서 감춘다. 보유 중이면 정상 노출되어
...
export const GUILD_RULES = {
  ...
  levels: [
    ...
    { level: 5, requiredGp: 25_000, memberLimit: 65, atk: 0.03, hp: 0.03, def: 0.03, points: 0 },
    { level: 6, requiredGp: 36_000, memberLimit: 65, atk: 0.04, hp: 0.03, def: 0.03, points: 0 },
    { level: 7, requiredGp: 50_000, memberLimit: 65, atk: 0.04, hp: 0.04, def: 0.03, points: 0.03 },
    { level: 8, requiredGp: 70_000, memberLimit: 65, atk: 0.04, hp: 0.04, def: 0.04, points: 0.03 },
    { level: 9, requiredGp: 92_000, memberLimit: 65, atk: 0.05, hp: 0.04, def: 0.04, points: 0.04 },
    { level: 10, requiredGp: 120_000, memberLimit: 65, atk: 0.05, hp: 0.05, def: 0.04, points: 0.05 },
  ],
};
