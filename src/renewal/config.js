...
export const WORLD_BOSS_RULES = {
  ...
  slotTiers: {
    ...
    // maxHp는 지정값(17:65억/18:70억/19:85억/20:95억)으로 고정 -> 참여가 부족한 회차는 실패 가능.
    ...
    19: {
      title: '공허 수확자', name: 'VOID//HARVESTER', difficultyMultiplier: 1.308,
      maxHp: 8_500_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.15,
      image: 'assets/renewal/worldboss/boss-19-void-harvester.webp',
    },
    20: {
      title: '악의 특이점', name: 'MALICE//SINGULARITY', difficultyMultiplier: 1.462,
      maxHp: 9_500_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.20,
