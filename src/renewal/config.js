...
export const WORLD_BOSS_RULES = {
  ...
  slotTiers: {
    ...
    // maxHp는 지정값(17:65억/18:70억/19:75억/20:80억)으로 고정 -> 참여가 부족한 회차는 실패 가능.
    // 2026-07-26 1차: 특성 상향으로 각 슬롯 +5억(55~70 -> 60~75).
    // 2026-07-26 2차: 17시 실측에서 최대 개인딜이 49.0M -> 54.3M(+11%)로 뛰어 다시 +5억.
    ...
    17: {
      ...
      maxHp: 6_500_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.05,
      image: 'assets/renewal/worldboss/boss-17-signal-bastion.webp',
    },
    18: {
      title: '중계 포식자', name: 'RELAY//DEVOURER', difficultyMultiplier: 1.077,
      maxHp: 7_000_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.10,
      image: 'assets/renewal/worldboss/boss-18-relay-devourer.webp',
    },
    19: {
      title: '공허 수확자', name: 'VOID//HARVESTER', difficultyMultiplier: 1.154,
      maxHp: 7_500_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.15,
      image: 'assets/renewal/worldboss/boss-19-void-harvester.webp',
    },
    20: {
      title: '악의 특이점', name: 'MALICE//SINGULARITY', difficultyMultiplier: 1.231,
      maxHp: 8_000_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.20,
