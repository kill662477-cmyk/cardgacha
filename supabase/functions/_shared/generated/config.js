...
export const WORLD_BOSS_RULES = {
  ...
  slotTiers: {
    ...
    // maxHp는 지정값(17:60억/18:65억/19:70억/20:75억)으로 고정 -> 참여가 부족한 회차는 실패 가능.
    // 2026-07-26: 특성 상향(약화·생존·강타·증폭)으로 유저 화력이 올라 각 슬롯 +5억.
    ...
    17: {
      ...
      maxHp: 6_000_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.05,
      image: 'assets/renewal/worldboss/boss-17-signal-bastion.webp',
    },
    18: {
      title: '중계 포식자', name: 'RELAY//DEVOURER', difficultyMultiplier: 1.083,
      maxHp: 6_500_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.10,
      image: 'assets/renewal/worldboss/boss-18-relay-devourer.webp',
    },
    19: {
      title: '공허 수확자', name: 'VOID//HARVESTER', difficultyMultiplier: 1.167,
      maxHp: 7_000_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.15,
      image: 'assets/renewal/worldboss/boss-19-void-harvester.webp',
    },
    20: {
      title: '악의 특이점', name: 'MALICE//SINGULARITY', difficultyMultiplier: 1.25,
      maxHp: 7_500_000_000, serverDamagePerSecond: 0, clearDestructionGuardRate: 0.20,
