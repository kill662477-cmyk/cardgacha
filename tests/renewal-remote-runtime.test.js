...
for (const command of [
  ...
  'PURCHASE_PACK', 'PURCHASE_SUPPORT_PACK', 'PURCHASE_ADVANCED_SUPPORT_PACK', 'PURCHASE_FIXED_SUPPORT_ITEM', 'USE_SUPPORT_ITEM', 'ENHANCE_CARD',
  'START_ADVENTURE_RUN', 'FINISH_ADVENTURE_RUN', 'START_MINIGAME', 'FINISH_MINIGAME',
  'BUY_LOTTO_TICKET', 'MARKET_TRADE',
